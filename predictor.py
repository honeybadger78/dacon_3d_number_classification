...
class Predictor:
    def __init__(self, model, device, args):
        ...
        self.test_loader, self.df = self.get_dataloader(
    ...
    def ensemble_predict_hardVoting(self):
        ...
        with torch.no_grad():
            for img in tqdm(self.test_loader):
                ...
                model_preds += batch_preds_label[
                    best_score_ind[batch_len], batch_len
                ].tolist()
        return model_preds

    def get_dataloader(self, csv_path, img_path, batch_size):
        img_set, df, transform = image_label_dataset(
            csv_path, img_path, grid_shuffle_p=0, training=False
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=[
            "./ckpt/58E-val0.957-efficientnet_b0.pth",
